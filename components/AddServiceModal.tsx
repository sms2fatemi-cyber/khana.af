...
const UserLocationBtn = () => {
  ...
  return (
    <button 
      ...
      className="absolute bottom-28 right-6 z-[1000] w-12 h-12 bg-white rounded-xl shadow-2xl flex items-center justify-center text-orange-600 border border-gray-100 active:scale-90"
    >
