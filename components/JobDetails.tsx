...
const ContactSection: React.FC<{
  ...
  <div className="space-y-4 bg-gray-50 p-6 rounded-[2.5rem] border border-gray-100 shadow-inner">
    ...
    <div className="flex gap-3">
      ...
      {!showContact ? (
        <button onClick={() => setShowContact(true)} className="flex-[2] bg-blue-700 text-white h-14 rounded-2xl font-black text-sm active:scale-95 shadow-md transition-all">{String(t.contact_info)}</button>
      ) : (
